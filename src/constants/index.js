...
const projects = [
    ...
    },
    {
        name: "PropIntel",
        description:
            "A tool for ingesting, enriching, verifying, and scoring real estate leads.",
    ...
    },
    {
        ...
        description:
            "Backend for the Automa project. API services and background jobs in Swift.",
    ...
    },
    {
        name: "SwiftWebDriver",
        description:
            "A Swift library for browser automation with Selenium.",
        tags: ["swift", "selenium"],
        image:
    ...
    },
    {
        name: "AutomaWebCore",
        description:
            "Minimal browser automation backend. Handles scraping jobs via an API.",
